...
export class OrderDto {
  ...
  @ApiProperty({ enum: OrderPriority, description: "Dérivée du rôle employé et du contexte (réunion, urgence)" })
  @IsEnum(OrderPriority)
  priority!: OrderPriority;

  @ApiProperty({ example: "2026-06-26T14:00:00.000Z", description: "Recalculée en temps réel côté Agent" })
  @IsDateString()
  slaDeadline!: string;
